...
const initialDefaultColumns = (titles: KanbanDefaultColumnTitles) => {
  ...
  const frontendTagId = nanoid();
  const backendTagId = nanoid();
  const uxTagId = nanoid();
  const qaTagId = nanoid();
  const now = Date.now();

  const backlogCardOneId = nanoid();
  const backlogCardTwoId = nanoid();
  const inProgressCardId = nanoid();
  const doneCardId = nanoid();
  ...
  return {
    columns: {
      [todoColId]: {
        id: todoColId,
        title: titles.todo,
        cardIds: [backlogCardOneId, backlogCardTwoId],
      },
      [inProgColId]: {
        id: inProgColId,
        title: titles.inProgress,
        cardIds: [inProgressCardId],
      },
      [doneColId]: {
        id: doneColId,
        title: titles.done,
    ...
    tags: {
      ...
      [backendTagId]: { id: backendTagId, name: "backend", color: "#8b5cf6" },
      [uxTagId]: { id: uxTagId, name: "ux", color: "#06b6d4" },
      [qaTagId]: { id: qaTagId, name: "qa", color: "#f59e0b" },
    },
    cards: {
      [backlogCardOneId]: {
        id: backlogCardOneId,
        ...
        subtasks: [
          {
            id: nanoid(),
            text: "Create /auth/callback endpoint",
            isCompleted: false,
          },
          {
            id: nanoid(),
            text: "Add social login button to the form",
            isCompleted: false,
          },
          {
            id: nanoid(),
            text: "Cover flow with E2E tests",
            isCompleted: false,
          },
        ],
        links: {
          branch: "feature/oauth-login",
          pr: "https://github.com/example/dev-utility-box/pull/42",
          commit: "a1b2c3d",
        },
      ...
      [backlogCardTwoId]: {
        ...
        subtasks: [
          {
            id: nanoid(),
            text: "Map first-time user journey",
            isCompleted: true,
          },
          {
            id: nanoid(),
            text: "Define microcopy for each step",
            isCompleted: false,
          },
        ],
        links: {
          branch: "feature/onboarding-checklist",
          pr: "https://github.com/example/dev-utility-box/pull/47",
        },
      ...
      [inProgressCardId]: {
        ...
        subtasks: [
          {
            id: nanoid(),
            text: "Extract reusable DnD utility functions",
            isCompleted: true,
          },
          {
            id: nanoid(),
            text: "Cover card and column reorder scenarios",
            isCompleted: false,
          },
          {
            id: nanoid(),
            text: "Validate mobile interactions",
            isCompleted: false,
          },
        ],
        links: {
          branch: "refactor/kanban-dnd",
          pr: "https://github.com/example/dev-utility-box/pull/51",
          commit: "f9e8d7c",
        },
      ...
      [doneCardId]: {
        ...
        subtasks: [
          { id: nanoid(), text: "Create language selector", isCompleted: true },
          {
            id: nanoid(),
            text: "Persist locale in storage",
            isCompleted: true,
          },
          { id: nanoid(), text: "Add regression tests", isCompleted: true },
        ],
        links: {
          branch: "feature/locale-switcher",
          pr: "https://github.com/example/dev-utility-box/pull/33",
          commit: "7c6b5a4",
        },
...
const createKanbanStore = (
  ...
  createStore<KanbanStoreState>()(
    persist((set, get) => createKanbanState(set, get, defaultColumnTitles), {
